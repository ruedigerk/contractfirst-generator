...
import server_spring.model.RestManual;
...
public interface MultipleContentTypesApi {
  ...
  class GetManualResponse extends ResponseWrapper {
    ...
    public static GetManualResponse with200ApplicationJson(RestManual entity) {
    ...
    public static GetManualResponse withApplicationJson(int status, RestFailure entity) {
