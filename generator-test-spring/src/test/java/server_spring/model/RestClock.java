...
public class RestClock {
  ...
  public RestClock time1(LocalDate time1) {
    this.time1 = time1;
    return this;
  }
  ...
  public RestClock time2(OffsetDateTime time2) {
    this.time2 = time2;
    return this;
  }
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "RestClock{").append('}').toString();
  }
}
