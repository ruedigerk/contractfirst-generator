...
class ResponseVariantsTest extends SpringWebIntegrationSpecification {
   ...
   */
  @RestController
  static class EmbeddedRestController implements ResponseVariantsApi {
    ...
    CreateItemResponse createItem(String systemId, Boolean dryRun, Long partNumber, String testCaseSelector, SItem requestBody) {
      ...
      if (testCaseSelector == "201") {
        ...
        return CreateItemResponse.withCustomResponse(ResponseEntity.internalServerError().contentType(MediaType.TEXT_PLAIN).body("This is just plain text"))
      } else {
