...
import server_jsr305.model.FormEncodedRequestBodyRequestBodyApplicationXWwwFormUrlencodedFieldC;
...
public interface FormEncodedRequestBodyApi {
  ...
  FormEncodedRequestBodyResponse formEncodedRequestBody(@FormParam("fieldA") String fieldA,
      ...
      @FormParam("fieldC") FormEncodedRequestBodyRequestBodyApplicationXWwwFormUrlencodedFieldC fieldC);
