...
sealed interface JavaAnyType {
  ...
  val flags: JavaTypeFlags

  /**
   * Returns whether this type is generic, being either a Collection or Map type.
   */
  fun isGenericType(): Boolean = when (this) {
    is JavaType -> false
    is JavaCollectionType, is JavaMapType -> true
  }

  /**
   * Returns whether this type is a type generated by the generator.
   */
  fun isGenerated(): Boolean = flags == JavaTypeFlags.Generated
...
data class JavaType(
  ...
  override val flags: JavaTypeFlags = JavaTypeFlags.None,
) : JavaAnyType {
...
data class JavaCollectionType(
  ...
  override val flags: JavaTypeFlags
    get() = JavaTypeFlags.None
...
/**
 * Defines the possible flags for a Java type to have.
 */
enum class JavaTypeFlags {

  /**
   * The type has no special properties.
   */
  None,

  /**
   * Signifies the type to be generated by the generator from the contract.
   */
  Generated,
}
