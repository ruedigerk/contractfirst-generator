 ...
 */
class PositionPathMatcher private constructor(private val segmentMatchers: List<(String) -> MatchResult?>) {
  ...
  companion object {
    ...
    @JvmStatic
    fun of(pattern: String): PositionPathMatcher = PositionPathMatcher(
